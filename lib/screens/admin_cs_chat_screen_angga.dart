...
class CsChatListScreenAngga extends StatelessWidget {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CsChatDetailScreenAngga(userName: name),
          ),
        );
      },
      child: Container(
...
class CsChatDetailScreenAngga extends StatefulWidget {
  ...
  const CsChatDetailScreenAngga({super.key, required this.userName});
