...
class DokuPaymentService {
  ...
  // TODO: Replace with your DOKU credentials from https://dashboard.doku.com
  static const String clientId = 'BRN-0262-1780146553005';
  static const String clientSecret = 'SK-60L1YUXahdcWnHQ7ezUX';
  // static const String baseUrl = 'https://api.doku.com'; // Production
  static const String baseUrl = 'https://staging-api.doku.com'; // Staging/Sandbox
  ...
  Future<DokuVirtualAccountResponse> createVirtualAccount({
    ...
    try {
      ...
      final requestBody = {
        ...
        'bank_code': bankCode,
        'invoice_ref_no': bookingId,
        'reference': 'VA-$bookingId-${DateTime.now().millisecondsSinceEpoch}',
        'currency': 'IDR',
        'order': {
          'items': [
            {
      ...
      final jsonBody = jsonEncode(requestBody);
      final path = '/payment/virtual-account-number/v2/create';
      final signature = _generateSignature('POST', path, timestamp, jsonBody);
      ...
      if (response.statusCode == 200) {
        final vaResponse = DokuVirtualAccountResponse.fromJson(response.data);
